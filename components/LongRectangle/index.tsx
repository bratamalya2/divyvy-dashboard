...
function LongRectangle({
  ...
  if (componentName.length === 0)
    return (
      <div
        className="relative w-[286px] h-[90px] self-stretch rounded-3xl border-t-[0.5px] border-r-[0.2px] border-b-[2px] border-l-[1.5px] border-[#FFF] mb-5 bg-[#F6F6F6] cursor-pointer"
        style={{
          boxShadow:
  ...
  return (
    <>
      <div
        className="flex w-[286px] h-[90px] self-stretch items-center rounded-3xl border-t-[0.5px] border-r-[0.2px] border-b-[2px] border-l-[1.5px] border-[#FFF] px-3 mb-5 cursor-pointer"
        style={{
          background:
